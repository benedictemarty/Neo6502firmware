...
| 2 Console | 21 Set Console Font | P0-1 = adresse RAM 6502 des 96 glyphes `$20-$7F` (8 octets/caractère, MSB à gauche) ; 0 = police interne | lus en place à chaque repeint (pas de copie) ; écran repeint ; erreur 1 si les 768 octets dépassent `$FFFF` ; police interne rétablie par 5,9 / reset ; cellules 14 lignes (mode 1) gardent la 8×14 | absente | F-95 |
