...
| 5 Graphics | 9 Set Graphics Mode | P0 = mode (0 : 320×240×256, 1 : Hercules 720×350 1 bpp 80×25, 2 : 320×256×16, 3 : Hercules 80×43 en 9×8 — F-57, 4 : TEXT Oric rendu depuis la RAM 6502 `$BB80` — ADR-04) | erreur si mode inconnu ou non supporté par l'hôte | absente | F-51 (ADR-02) |
