...
| F-71 | P3 | Rendu TEXT (`$BB80`, attributs série) et HIRES (`$A000`, 240×200) Oric. | EPIC-02 | **WIP** 2026-09-18 (ADR-04 tranche a) : **TEXT = mode vidéo 4** (`memvideo.cpp`, `LAYOUT_ORIC_TEXT`, attributs série, jeux de caractères en RAM, couleurs Oric), test `orictext.asm` (`neo`), USB/SDCARD compilés (marge tas USB 2 220 o), **non testé sur carte** (mesure F-50 requise, R30) ; HIRES : à faire (tranche b) |
...
| F-44 | P3 | **Menu (35) et Control (36) Managers**. | | **WIP** 2026-09-18 : Menu Manager fait (`feat/menu-manager` : 35,1-35,8, descripteurs en RAM 6502, `menu.asm`) ; Control Manager (36) à faire |
