...
| T-05 | P1 | Lecture par blocs CDC : servir l'hôte USB pendant l'attente (R16). | **DONE** 0.2.1 (session parallèle) ; ProphetGui à revalider |
| T-06 | P1 | ProphetGui de bout en bout sur carte (F-94) : catalogue, fiche, téléchargement. | TODO |
