; rtos_idle.asm — comme rtos.asm mais la tâche principale DORT (KTaskSleep 50) au lieu
; de scruter : toutes les tâches dorment par moments → chemin « rien de prêt »
; (WAI + acquittement) de l'ordonnanceur.
;   tâche 0 (principale) : dort 50 ticks, affiche "T=" + compteur de ticks
...
;   64tass --mw65c02 --nostart --output=rtos_idle.neo6502 rtos_idle.asm
